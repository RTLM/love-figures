...
<div class="jumbotron jumbotron-fluid" style="padding: 0">
    <div class="hero">
        <img src="http://via.placeholder.com/2000x400" class="img-fluid mx-auto" alt="Responsive image" style="width: 100%">
...
<div class="container">
    ...
    <div class="row justify-content-md-center text-center">
        <div class="border rounded col-sm-4" style="margin: 1rem; padding: 1rem;">
...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <div class="text-center">
            <h1 class="display-4">Packages starting from $99</h1>
            <p class="lead"><a href="">View here</a></p>
        </div>
    </div>
</div>
